 ...
 */
export function btrSeal(messageKey: Uint8Array, plaintext: Uint8Array): Uint8Array {
 ...
 */
export function btrSealDeterministic(
 ...
 */
export function btrOpen(messageKey: Uint8Array, sealed: Uint8Array): Uint8Array {
