 ...
 *
 * WARNING: All keypairs generated here are TEST-ONLY fixtures.
 * They are deterministic, publicly known, and MUST NEVER be used in production.
 */
...
const boxPayload = {
  description: 'Deterministic NaCl box payload test vectors for @the9ines/bolt-core. Generated by scripts/print-test-vectors.mjs. WARNING: All keypairs are TEST-ONLY fixtures — NEVER use in production.',
  sender: {
...
const framing = {
  description: 'Wire format framing test vectors for @the9ines/bolt-core. Verifies nonce||ciphertext layout. WARNING: Sealed payloads use TEST-ONLY keypairs — NEVER use in production.',
  constants: {
    nonce_length: 24,
